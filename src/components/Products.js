...
const Products = () => {
    ...
    const columns = [
        ...
        { title: "Date", data: "date" },
        {
            ...
            render: function (data, type, row) { // Custom render function
                return `
    ...
    const handleUpdate = async () => {
        try {
            const response = await fetch(`http://localhost:5000/api/products/${updateId}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        <div className="products-page">
            ...
            {/* Add Product Modal */}
            <Modal show={showAddModal} onHide={() => setShowAddModal(false)} centered className="modal">
